...
const serve = () => {
    ...
    app.get('/', (req, res) => {
        res.send(`<html><head><link rel="icon" href="https://bit.ly/haicon"><meta name="viewport"content="width=device-width,initial-scale=1"><title>Haiya Discord Bot</title></head><body style='padding-top:10px;background-color:#121212;color:#fff;font-family:"Trebuchet MS",sans-serif;text-align:center;'><h1>Haiya Discord Bot</h1></body></html>`)
    });
